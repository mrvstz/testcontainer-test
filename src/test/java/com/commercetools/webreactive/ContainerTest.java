...
public class ContainerTest  {
    ...
    @ClassRule
    public static KafkaContainer kafkaContainer = new KafkaContainer("4.1.1").withExposedPorts(2181,9093);;
    ...
    private void pushToKafka() {
        ...
        KafkaProducer kafkaProducer;kafkaProducer = new KafkaProducer(of);
